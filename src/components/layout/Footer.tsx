        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6 max-w-sm">
              <span className="font-bold text-green-800">PLOT</span><span className="text-[#F97316] font-bold">RAY</span> is your trusted partner for strategic land investments near growing cities. We connect buyers with premium land opportunities.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} <span className="font-bold text-green-800">PLOT</span><span className="text-[#F97316] font-bold">RAY</span>. All rights reserved.
            </p>
          </div>
        </div>
      </div>
