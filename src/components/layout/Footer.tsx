        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed mb-6 max-w-sm">
              <span className="font-bold text-orange-500">PLOT</span><span className="text-[#C2410C] font-bold">RAY</span> is your trusted partner for strategic land investments near growing cities. We connect buyers with premium land opportunities.
            </p>
