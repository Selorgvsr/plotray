      ...
      <div className="container-custom">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <img alt="PLOTRAY - Land Investment Platform" className="h-24 md:h-28 w-auto object-contain mt-3" src="/lovable-uploads/Gemini_Generated_Image_694q4y694q4y694q-removebg-preview.png" />
