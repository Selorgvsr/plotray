...
const projectAdvantages = [
  { text: "2 Minutes from Urapakkam Railway Station", icon: Train },
  { text: "3 Minutes from Kilambakkam Bus Terminus & upcoming Metro Rail Station", icon: Bus },
  { text: "2 Minutes from GST Road", icon: MapPin },
  { text: "10 Minutes from Tambaram", icon: Clock },
  { text: "15 Minutes from Airport", icon: Plane }
];

const specifications = [
  "High-Strength Concrete Roads",
  "Solar-Powered Street Lights",
  "Paved Walkways",
  "Underground Stormwater Drains",
  "Underground Pipelines for Electric Cables",
  "Underground Pipelines for Water Supply",
  "Kids Play Area",
  ...
  return (
    <Layout>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        {/* Background gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-rose-50 via-amber-50/50 to-rose-100" />
            ...
            {amenities.map((amenity, index) => (
              <div
                ...
                className={`group relative overflow-hidden rounded-2xl shadow-lg transition-all duration-700 ${
                  visibleAmenities.includes(index) 
      ...
      <section 
        ref={advantagesRef}
        className="py-20 md:py-32 bg-gradient-to-b from-white to-rose-50/50"
      >
        <div className="container-custom px-4">
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20 transition-all duration-1000 ${
            visibleAdvantages ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
          ...
          <div className={`bg-gradient-to-br from-primary/5 to-primary/10 rounded-3xl p-8 md:p-12 transition-all duration-1000 delay-300 ${
            visibleAdvantages ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {specifications.map((spec, index) => (
                <div 
                  key={index}
                  className="flex items-center gap-3 bg-white rounded-xl p-4 shadow-sm border border-rose-100/50"
                  style={{ 
                    opacity: visibleAdvantages ? 1 : 0,
        ...
        <div className="container-custom px-4 py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <a 
                href="tel:+917824013494" 
                className="hidden md:flex items-center gap-2 px-4 py-2 bg-primary hover:bg-primary/90 text-primary-foreground rounded-full transition-colors"
              >
                <Phone className="w-5 h-5" />
