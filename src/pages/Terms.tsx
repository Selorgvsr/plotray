...
const termsData = [
  {
    ...
    content: [
      "Plotray operates under Indian laws (IT Act 2000, RERA 2016).",
      "Using our platform means you accept these terms fully.",
      "We may update terms—check regularly."
    ]
  },
  {
    id: "2",
    ...
    content: [
      "Buy/Sell Land: Verified listings, direct transactions",
      "Land Asset Tracking: Portfolio monitoring tools",
      "Site Visits: Free for serious inquiries",
      "No guarantees on investment returns—market risks apply."
    ]
  },
  {
    id: "3",
    ...
    content: [
      "Provide accurate land details/documents",
      "Comply with local property laws (Tamil Nadu rules)",
      "No fraudulent listings or spam",
  ...
  },
  {
    ...
    content: [
      "Fair market pricing based on location data",
      "Secure payments via bank transfer/UPI",
      "7-day cooling period for offers",
      "All transactions are GST-compliant (18% on services)."
    ]
  },
  {
    id: "5",
    ...
    content: [
      ...
      "We collect name, phone, and land details for verification.",
      "No sharing without consent—see Privacy Policy."
    ]
  },
  {
    id: "6",
    ...
    content: [
      "Plotray is not liable for market losses or title disputes.",
      "Max liability: transaction value.",
      "Force majeure (delays, disputes) exempt."
    ]
  },
  {
    id: "7",
    ...
    content: [
      "Tamil Nadu courts have exclusive jurisdiction.",
      "Disputes resolved via arbitration (Chennai).",
  ...
  },
  {
    ...
    content: [
      ...
      "You can stop using services anytime.",
        ...
        <div className="container-custom max-w-4xl">
          <div className="bg-card rounded-2xl border border-border p-6 md:p-10 mb-8">
            <p className="text-muted-foreground text-lg leading-relaxed mb-6">
              By using Plotray services, you agree to these terms. Read carefully.
            </p>
