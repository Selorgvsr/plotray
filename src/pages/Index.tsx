  ...
  return <Layout>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center pt-20">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-bold text-white mb-8 animate-fade-in leading-tight">Where Smart Land Meets Future City
          <br />
          ...
          <div style={{
          animationDelay: '0.3s'
        }} className="flex flex-col sm:flex-row gap-4 justify-center mt-12 animate-fade-in text-white">
            <Link to="/buy">
