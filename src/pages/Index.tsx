  ...
  return <Layout>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container-custom relative z-10 text-center pt-20">
          <h1 className="text-4xl md:text-6xl font-heading font-bold text-white mb-8 animate-fade-in leading-tight lg:text-5xl">We support Financial Peace on Land Investment
Plots in Prime Location
Clear Legal Titles
Statutory Approval from Government
Investment in Prime Land always Appreciated<br />
