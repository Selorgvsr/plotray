    ...
    <Layout>
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${landassetHero})` }} 
        />
        <div className="absolute inset-0 bg-gradient-to-br from-primary/90 via-primary/70 to-plotray-emerald/80" />
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-white max-w-5xl mx-auto leading-tight animate-fade-in">
            Your Land Is More Than Property—It's a Growing Asset
          </h1>
        </div>
      </section>
